...
export default function ListingItem({ listing, id, onEdit, onDelete }) {
  return (
    <li className="bg-white relative flex flex-col justify-between items-center m-[10px] mx-5 hover:scale-105 shadow-md hover:shadow-lg rounded-md overflow-hidden duration-300 gap-2">
        ...
        <div className="w-full p-[10px] flex items-start gap-1.5 justify-center flex-col">
          <div className="flex items-center gap-1 flex-row justify-center">
            ...
            <p className="font-semibold text-sm text-gray-600 truncate">
              Lat: {listing?.latitude.toString().slice(0, 5)}, Long: {listing?.longitude.toString().slice(0, 5)}
            </p>
          </div>
