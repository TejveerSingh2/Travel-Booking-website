...
export default function Profile() {
  ...
  return (
    <HelmetProvider>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Dream Dwellings | Profile</title>
      </Helmet>
      <>
        <section className="max-w-6xl w-full mx-auto px-10 flex justify-center flex-col">
          <h1 className="text-3xl mt-6 font-bold">My Profile</h1>
          <div className="w-full md:w-1/2 flex flex-col items-center mt-6 gap-4">
            <form className="w-full flex flex-col items-center justify-center mt-6 gap-4">
              <input
                type="text"
                id="name"
                value={name}
